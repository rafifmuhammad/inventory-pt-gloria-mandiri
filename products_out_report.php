...
$products = query("SELECT * FROM tb_barang_keluar ORDER BY tanggal_keluar");
...
$pdf->cell(8);
$header = ['NO.', 'TANGGAL KELUAR', 'ID BARANG', 'NAMA BARANG', 'JUMLAH BARANG'];
...
foreach ($products as $product) {
    ...
    $pdf->Cell($w[1], 6, $product['tanggal_keluar'], 1, 0, 'C');
