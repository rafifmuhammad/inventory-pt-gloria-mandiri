...
$product = get_single_product('tb_barang_masuk', '*', $id_barang);

if (isset($_POST['submit'])) {
    if (update_product_in($_POST, $id_barang) > 0) {
        echo "
            <script>
...
<head>
    ...
    <title>Inventaris App - Ubah Barang Masuk</title>
            ...
            <div class="row mbn-50">
                ...
                <div class="row mbn-30">
                    ...
                    <div class="col-xlg-12 col-lg-6 col-12 mb-30">
                        <div class="box">
                            <div class="box-head">
                                <h3 class="title">Informasi Barang Masuk</h3>
                            </div>
                            <div class="box-body">
                                <div class="form">
                                    <form action="" method="post">
                                        <div class="row row-10 mbn-20">
                                            ...
                                            <input type="hidden" name="tanggal_masuk" id="tanggal_masuk" value="<?php echo $product['tanggal_masuk']; ?>">
