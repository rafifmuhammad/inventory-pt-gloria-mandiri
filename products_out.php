...
if (isset($_POST['find'])) {
    ...
    $products = query("SELECT * FROM tb_barang_keluar WHERE nama_barang LIKE '%$product%'");
}
                                ...
                                <div>
                                    <form action="" method="post">
                                        <div class="row mr-15">
                                            ...
                                            <button class="button button-secondary mt-5 ml-5 mb-5" type="submit" name="find">Search</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- end search products -->
